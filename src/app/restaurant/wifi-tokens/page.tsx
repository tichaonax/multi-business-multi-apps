...
export default function RestaurantWifiTokensPage() {
  ...
  useEffect(() => {
    ...
    // Check permission
    const permitted = hasPermission('canConfigureWifiTokens')
  ...
  return (
    <ContentLayout
      ...
      description="Manage WiFi access tokens for your restaurant POS"
    >
