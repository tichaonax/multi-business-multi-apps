...
export default function RestaurantR710TokensPage() {
  ...
  return (
    <ContentLayout
      ...
      description="Configure pricing and availability of R710 WiFi tokens for your restaurant POS"
    >
      <R710TokenMenuManager businessId={currentBusinessId!} businessType="restaurant" />
    </ContentLayout>
  )
}
