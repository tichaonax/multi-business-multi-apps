          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500 dark:text-gray-400 mb-4">
                Add advertising notes, images, and configure how each menu item appears on the rotating display.
              </p>
              <DisplayItemsManager businessId={currentBusinessId} businessType="restaurant" />
            </div>
          </div>
        </ContentLayout>
      </BusinessTypeRoute>
