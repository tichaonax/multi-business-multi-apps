...
/**
 * GET /api/payroll/periods/[periodId]/reports/nec
 * Returns NEC employee + company contribution data.
 */
export async function GET(request: NextRequest, { params }: RouteParams) {
  try {
    ...
    console.error('Error generating NEC report:', error)
    return NextResponse.json({ error: 'Failed to generate NEC report' }, { status: 500 })
  }
}
