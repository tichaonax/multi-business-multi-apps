...
const ALL_TABLES = [
  ...
  'employeeAbsences', 'leavePolicies',
  ...
  'vehicles', 'vehicleDrivers', 'vehicleRenewalReceipts', 'vehicleLicenses',
  'vehicleMaintenanceRecords', 'vehicleMaintenanceServices', 'vehicleMaintenanceServiceExpenses',
  'vehicleTrips', 'vehicleExpenses', 'vehicleReimbursements', 'driverAuthorizations',
  'vehicleExemptions', 'issuingAuthorities', 'projects',
