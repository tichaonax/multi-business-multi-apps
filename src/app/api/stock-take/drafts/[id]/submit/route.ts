        ...
        if (existing) {
          ...
          await prisma.barcodeInventoryItems.update({
            ...
            data: {
              ...
              ...(item.unitsPerPack !== null ? { unitsPerPack: Number(item.unitsPerPack) } : {}),
              ...(item.bulkPackCost !== null ? { bulkPackCost: Number(item.bulkPackCost) } : {}),
        ...
        if (existingByBarcode) {
          ...
          await prisma.barcodeInventoryItems.create({
            data: {
              ...
              unitsPerPack: item.unitsPerPack !== null ? Number(item.unitsPerPack) : null,
              bulkPackCost: item.bulkPackCost !== null ? Number(item.bulkPackCost) : null,
              sellingPrice,
