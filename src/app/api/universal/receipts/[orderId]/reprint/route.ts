...
export async function POST(
  ...
  try {
    ...
    const orderData = {
      ...
      customerPhone: order.business_customers?.phone || undefined,
      customerAddress: order.business_customers?.address || undefined,
      customerCity: order.business_customers?.city || undefined,
