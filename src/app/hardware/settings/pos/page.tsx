...
export default function HardwarePosSettingsPage() {
    ...
    return (
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900 flex items-center justify-center">
        <div className="text-center space-y-3">
          ...
          <Link href="/hardware/pos" className="text-blue-600 hover:underline text-sm">← Back to POS</Link>
        </div>
      </div>
    )
  }
