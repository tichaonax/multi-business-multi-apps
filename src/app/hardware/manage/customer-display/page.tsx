...
export default function HardwareCustomerDisplayPage() {
      ...
      <BusinessTypeRoute requiredBusinessType="hardware">
        <ContentLayout
          ...
          breadcrumb={[
            ...
            { label: 'Manage', href: '/hardware/manage' },
          ...
          <div className="space-y-6">
            ...
            <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4">
              ...
              <p className="text-sm text-blue-800 dark:text-blue-200 mb-2">
                When the POS system is idle (no items in cart), the customer-facing display shows a rotating slideshow of your uploaded advertisements. This is a great way to promote tool rentals, contractor specials, or seasonal products.
              </p>
