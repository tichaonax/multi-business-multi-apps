      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-4">
          ...
          <div className="card p-6">
            <h3 className="text-lg font-semibold text-primary mb-4">Product Entry</h3>
          ...
          {/* Shopping Cart */}
          <div className="card p-6">
            <h3 className="text-lg font-semibold text-primary mb-4">Shopping Cart</h3>
            ...
            {customer ? (
              <div className="space-y-3">
                <div>
                  ...
                  <div className="text-sm text-gray-600">Loyalty: {customer.loyaltyNumber}</div>
                </div>
                <div className="flex items-center justify-between">
                  <span className={`px-2 py-1 rounded text-xs ${
                    customer.loyaltyTier === 'Platinum' ? 'bg-gray-100 text-gray-800' :
                    customer.loyaltyTier === 'Gold' ? 'bg-yellow-100 text-yellow-800' :
                    customer.loyaltyTier === 'Silver' ? 'bg-gray-100 text-gray-600' :
                ...
                {customer.snapBalance && (
                  <div className="text-sm">
                    <span className="text-gray-600">SNAP Balance:</span>
