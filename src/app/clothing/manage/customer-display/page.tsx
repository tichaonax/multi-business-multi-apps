...
export default function ClothingCustomerDisplayPage() {
      ...
      <BusinessTypeRoute requiredBusinessType="clothing">
        <ContentLayout
          ...
          breadcrumb={[
            ...
            { label: 'Manage', href: '/clothing/manage' },
          ...
          <div className="space-y-6">
            ...
            <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4">
              ...
              <p className="text-sm text-blue-800 dark:text-blue-200 mb-2">
                When the POS system is idle (no items in cart), the customer-facing display shows a rotating slideshow of your uploaded advertisements. This is a great way to promote new collections, seasonal sales, or loyalty programs.
              </p>
            ...
            <div>
              ...
              <p className="text-sm text-gray-500 dark:text-gray-400 mb-4">
                Add advertising notes and images to items shown on the rotating customer display.
              </p>
              <DisplayItemsManager businessId={currentBusinessId} businessType="clothing" />
            </div>
          </div>
        </ContentLayout>
      </BusinessTypeRoute>
