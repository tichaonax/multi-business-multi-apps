...
export default function ClothingR710TokensPage() {
  ...
  useEffect(() => {
    ...
    // Check business type
    if (currentBusiness?.businessType !== 'clothing') {
  ...
  return (
    <ContentLayout
      ...
      description="Configure pricing and availability of R710 WiFi tokens for your clothing store POS"
    >
      <R710TokenMenuManager businessId={currentBusinessId!} businessType="clothing" />
    </ContentLayout>
  )
}
