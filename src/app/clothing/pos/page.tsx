          ...
          <div className="space-y-6">
            ...
            {posMode === 'live' && (useAdvancedPOS ? (
              ...
              <div className={`grid gap-4 items-start ${showProductGrid ? 'grid-cols-1 lg:grid-cols-3' : 'grid-cols-1'}`}>
                ...
                <div id="pos-cart-panel" className={!showProductGrid ? 'max-w-2xl mx-auto w-full' : 'sticky top-14 sm:top-16 self-start max-h-[calc(100vh-5.5rem)] overflow-y-auto rounded-xl'}>
                  <UniversalPOS
                    businessId={businessId}
                    employeeId={employeeId!}
                    terminalId={terminalId}
