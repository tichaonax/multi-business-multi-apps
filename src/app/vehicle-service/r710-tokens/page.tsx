...
export default function VehicleServiceR710TokensPage() {
  ...
  useEffect(() => {
    ...
    // Check business type
    if (currentBusiness?.businessType !== 'vehicle_service') {
    ...
    return (
      <ContentLayout title="R710 WiFi Token Menu">
        <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-6">
          <h3 className="font-medium text-yellow-900 mb-2">R710 Integration Not Setup</h3>
  ...
  return (
    <ContentLayout
      ...
      description="Configure pricing and availability of R710 WiFi tokens for your vehicle service business POS"
    >
      <R710TokenMenuManager businessId={currentBusinessId!} businessType="vehicle_service" />
    </ContentLayout>
  )
}
