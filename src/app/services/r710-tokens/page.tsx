...
export default function ServicesR710TokensPage() {
  ...
  return (
    <ContentLayout
      ...
      description="Configure pricing and availability of R710 WiFi tokens for your services business POS"
    >
      <R710TokenMenuManager businessId={currentBusinessId!} businessType="services" />
    </ContentLayout>
  )
}
