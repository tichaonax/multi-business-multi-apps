  ...
  return (
    ...
    <div className="flex min-h-screen page-background">
      ...
      <main className="flex-1 lg:pl-64 min-w-0 [overflow-x:clip]">
        {/* Plain, symmetric padding — the mobile hamburger now lives in
            GlobalHeader's own persistent top bar (see MobileSidebar), not as
            a fixed button floating over this content, so nothing here needs
            to reserve space for it any more. */}
