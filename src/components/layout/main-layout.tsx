  ...
  return (
    ...
    <div className="flex min-h-screen page-background">
      ...
      <main className="flex-1 lg:pl-64 min-w-0 [overflow-x:clip]">
        {/* pl-14 on mobile reserves space for the fixed hamburger (left-3, ~46px wide); sm:px-4 restores symmetric padding once the screen is wide enough */}
        <div className="pl-14 pr-3 sm:px-4 lg:px-6 xl:px-8 py-2 sm:py-3 pb-20">
          {children}
        </div>
      </main>
    </div>
