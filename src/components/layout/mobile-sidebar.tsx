      ...
      case 'grocery':
        return (
          <>
            ...
            {(isAdmin || hasBusinessPermission('canManagePromotions')) && navLink('/grocery/promotions', '🏷️', 'Promotional Sales')}
      ...
      case 'clothing':
        return (
          <>
            ...
            {(isAdmin || hasBusinessPermission('canManagePromotions')) && navLink('/clothing/promotions', '🏷️', 'Promotional Sales')}
