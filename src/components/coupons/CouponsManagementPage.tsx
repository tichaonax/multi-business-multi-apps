...
export default function CouponsManagementPage() {
  ...
  const businessType = currentBusiness?.type || currentBusiness?.businessType || 'business'
      ...
      <BusinessTypeRoute requiredBusinessType={getSupportedBusinessTypes()}>
        <ContentLayout
          ...
          breadcrumb={[
            ...
            { label: businessType.charAt(0).toUpperCase() + businessType.slice(1), href: `/${businessType}` },
