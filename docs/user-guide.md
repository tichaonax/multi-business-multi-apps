...
- If the business you switch to has never been paired on this exact workstation, its scale/printer is simply cleared/deactivated here — nothing from the previous business is left connected.
