...
import { sendToPrinter } from './src/lib/printing/printer-service-usb';
import { convertToESCPOS, initializePrinter, setBold, setAlignment, feedPaper, cutPaper } from './src/lib/printing/formats/esc-pos';
