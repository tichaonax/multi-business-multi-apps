...
|----|-------|------|--------|
| MBM-298 | Fix Product Photo Camera/Crop Pipeline (resume from MBM-297 Phase C) | [view](ai-contexts/project-plans/review/projectplan-MBM-298-product-photo-camera-crop-fix-2026-09-19.md) | 🟢 CORE BUG FIXED — live-verified on a real Android device; root cause was a click-bubbling bug closing the whole dialog mid-async-step. Background-removal timeout and inventory-workflow mobile responsiveness shelved as follow-ups (branch `feature/mbm-298-product-photo-camera-crop-fix`) |
| MBM-297 | Bulk-Cost Corrections, Exceptions Report Enhancements & Product Image Pipeline | [view](ai-contexts/project-plans/review/projectplan-MBM-297-bulk-cost-corrections-and-image-pool-2026-09-15.md) | 🟡 PLANNED — Phase 0 (search/pagination standardization) scoped in full and ready to build; Phases A–C (exceptions bulk-cost detection, correction workflow, image pipeline) scoped, detailed further before each starts (branch `feature/bulk-cost-corrections-and-image-pool`) |
| MBM-296 | Product Pricing, Cost & Value Exceptions + Performance + Min-Stock + Inventory Valuation + Poor-Performer Reports | [view](ai-contexts/project-plans/review/projectplan-MBM-296-product-pricing-inventory-intelligence-reports-2026-09-13.md) | 🟢 BUILT (all 6 phases) — typechecked clean, live-verified against real dev data; not yet browser-tested (branch `feature/product-pricing-inventory-reports`) |
| NOTKT | Streaming Backup/Restore + Real Progress Reporting (MBM-294 image data made backups OOM-risky) | [view](ai-contexts/project-plans/review/projectplan-NOTKT-streaming-backup-restore-2026-09-13.md) | 🟡 PLAN WRITTEN — awaiting scope decision (Option A vs B), not yet implemented |
| NOTKT | Admin Account Safeguards: disable default test admin, last-active-admin protection, 3-step typed confirmation | [view](ai-contexts/project-plans/review/projectplan-NOTKT-admin-account-safeguards-2026-09-12.md) | 🟡 PLAN WRITTEN — awaiting review, not yet implemented |
| MBM-294 | Clothing Category/Image Import + Product-Image Picker + Backup Fixes (Part A) + Business-Wide Image Gallery w/ Inventory Linkage, Tags & Turnover Analytics (Part B) | [view](ai-contexts/project-plans/review/projectplan-MBM-294-clothing-category-image-system-2026-09-05.md) | 🟢 IN PROGRESS on `feature/mbm-294-category-image-gallery` — Phases 1/2/3/4/7 done (Phase 4 built + query-verified, needs live browser check), next: Phase 8 (Part B reverse-lookup API) |
