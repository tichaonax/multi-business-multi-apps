...
async function createBusinessAccounts(businessId, businessName, creatorId = 'admin-system-user-default') {
  const INCOME_AMOUNT = 10000    // Opening credit on business account (represents accumulated sales)
  const EXPENSE_TRANSFER = 3000  // Transfer from business account → expense account
