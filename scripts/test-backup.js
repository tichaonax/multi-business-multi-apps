...
async function testBackup() {
  ...
  try {
    ...
    console.log()
    console.log('Business Data Tables:', Object.keys(backupData.businessData || {}).length)
    console.log('Shared Data Tables:', Object.keys(backupData.sharedData || {}).length)
    if (backupData.deviceData) {
      console.log('Device Data Tables:', Object.keys(backupData.deviceData).length)
    }
    console.log()
