...
class ConflictResolver {
    ...
    initializeDefaultRules() {
        this.addResolutionRule((0, db_names_1.getDbName)('users'), {
            tableName: (0, db_names_1.getDbName)('users'),
            strategy: 'NODE_PRIORITY',
            priority: 10,
            businessRules: [
        ...
        this.addResolutionRule((0, db_names_1.getDbName)('businessOrders'), {
            tableName: (0, db_names_1.getDbName)('businessOrders'),
            strategy: 'MERGE_CHANGES',
            priority: 9,
            businessRules: [
        ...
        this.addResolutionRule((0, db_names_1.getDbName)('employees'), {
            tableName: (0, db_names_1.getDbName)('employees'),
            strategy: 'BUSINESS_RULE',
            priority: 8,
            businessRules: [
        ...
        this.addResolutionRule((0, db_names_1.getDbName)('businessProducts'), {
            tableName: (0, db_names_1.getDbName)('businessProducts'),
            strategy: 'LAST_WRITER_WINS',
            priority: 7
        });
        this.addResolutionRule((0, db_names_1.getDbName)('auditLogs'), {
            tableName: (0, db_names_1.getDbName)('auditLogs'),
            strategy: 'KEEP_BOTH',
            priority: 6
        });
    }
