...
class SyncSystemValidator {
    ...
    async validateSecurityManagerCreation() {
        await this.runTest('SecurityManager Creation', async () => {
            ...
            const securityManager = (0, security_manager_1.createSecurityManager)(prisma, 'validation-security-node', {
    ...
    async validateSecurityAuthentication() {
        await this.runTest('Security Authentication', async () => {
            const prisma = new client_1.PrismaClient();
            const securityManager = (0, security_manager_1.createSecurityManager)(prisma, 'auth-test-node', {
    ...
    async validateDataEncryption() {
        await this.runTest('Data Encryption', async () => {
            const prisma = new client_1.PrismaClient();
            const securityManager = (0, security_manager_1.createSecurityManager)(prisma, 'encryption-test-node', {
